...
setDescription(e.target.value)
  ...
  const handleAddProduct = () => {
    if (title == "" || price == 0 || quantity == 0 || imagePreview == null) {
      alert("Ajout invalid ,s'assurer que tous les champs sont remplis.");
      setTitle("");
      setPrice(0);
      setQuantity(0);
      setDescription("");
  ...
  if (!addClicked)
    return (
      <div className="bg-color1">
        ...
        <div className="addbttnContainer">
          <button className="addbttn" onClick={() => handleAddClick()}>
            Add new Product
          </button>
        </div>
      </div>
            ...
            <form>
              ...
              <div class="row">
                <img
                  src={
                    imagePreview ||
                    "https://i.pinimg.com/564x/ba/1b/3a/ba1b3a5b00239da009b9733a4a943326.jpg"
                  }
                  alt="image produit"
                ...
                <div
                  className="addbttncontainer1"
                  onClick={() => handleAddClick()}
                >
                  <button className="addbttn">Retour</button>
                </div>
              </div>
            </form>
          </div>
