      ...
      <div class="container p-4">
        <div class="row my-4">
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <p class="text-center">Aura, un espace dédié aux créatifs</p>
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 class="text-uppercase mb-4">Produits exposés</h5>

            <ul class="list-unstyled">
              <li class="mb-2">
                <a href="#!" class="text-white">
                  <i class="fas fa-paw pe-3"></i>montres
                </a>
              </li>
              <li class="mb-2">
                <a href="#!" class="text-white">
                  <i class="fas fa-paw pe-3"></i>bijoux
                </a>
              </li>
              <li class="mb-2">
                <a href="#!" class="text-white">
