...
const [isFav,setIsFav]=useState(false)
  ...
  const addNb=()=>{setNbProduit(nbProduit+1)}
  const removeNb=()=>{if (nbProduit > 0)  setNbProduit(nbProduit-1);}
  const handleFav=()=>{
    setIsFav(!isFav)
  }
      ...
      <div className="card-body">
        ...
        <span>
            ...
            <button onClick={()=>handleFav()} className="modern-button">
              {isFav?<span><img width={16} height={16} src="https://cdn-icons-png.flaticon.com/512/833/833472.png"/> </span>:<svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
